...
# 系统提示词
system_prompt = """
你是一个AI助手，能够使用以下工具来帮助用户完成文件操作和网络访问任务：
...
def main():
    ...
    history = []
    print('=== LLM Tool Client with Web Access ===')
    print('You can ask me to perform file operations or fetch webpages.')
    print('For example: "List files in the practice01 directory" or "Fetch content from https://example.com"')
